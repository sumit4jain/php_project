...
<div class="container">
  <ul class="responsive-table">
    ...
    <li class="table-row">
      ...
      <div class="col col-2" data-label="Customer Name"><?php echo $row['first_name'],' ',$row['last_name'] ?></div>
      <div class="col col-3" data-label="Amount"><?php echo $row['bill']; ?></div>
      <div class="col col-4" data-label="Payment Status"><?php echo $row['contact']; ?></div>
    </li>
    <?php } ?>
  </ul>
  <?php } ?>
